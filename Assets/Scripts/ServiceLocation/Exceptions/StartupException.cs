...
{
    /// <summary>
    /// The exception that is thrown when there is an error initializing the service locator.
    /// </summary>
    public class StartupException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StartupException"/> class with a specified error message.
        /// </summary>
