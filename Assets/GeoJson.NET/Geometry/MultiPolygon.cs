...
namespace GeoJSON.Net.Geometry
{
    ...
    public class MultiPolygon : GeoJSONObject, IGeometryObject, IEqualityComparer<MultiPolygon>, IEquatable<MultiPolygon>
    {
        ...
        public MultiPolygon(IEnumerable<Polygon> polygons)
        {
            ...
            Coordinates = new ReadOnlyCollection<Polygon>(polygons != null ? polygons.ToArray() : null);
        }
        ...
        public MultiPolygon(IEnumerable<IEnumerable<IEnumerable<IEnumerable<double>>>> coordinates)
            : this(coordinates != null ? coordinates.Select(polygon => new Polygon(polygon)) : null)
        {
            if (this == null)
        ...
        public ReadOnlyCollection<Polygon> Coordinates { get; private set; }
