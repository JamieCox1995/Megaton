...
namespace GeoJSON.Net.Geometry
{
    ...
    public class LineString : GeoJSONObject, IGeometryObject, IEqualityComparer<LineString>, IEquatable<LineString>
    {
        ...
        : this(coordinates != null ? coordinates.Select(latLongAlt => (IPosition)latLongAlt.ToPosition()) : null)
        {
            if (this == null)
        ...
        {
            Coordinates = new ReadOnlyCollection<IPosition>(coordinates as IPosition[] ?? coordinates.ToArray());
        ...
        public ReadOnlyCollection<IPosition> Coordinates { get; private set; }
